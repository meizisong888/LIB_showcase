...
export function ResponsibleUsePage() {
  return <>
    ...
    <section className="safety-boundary"><div className="container"><SafetyCallout title="Export-controlled data and CUI: no AI tool"><p>Virginia Tech’s current AI Tools page states that high-risk data classified as export controlled or Controlled Unclassified Information is not authorized for use with any AI tool.</p><a href="https://ai.vt.edu/tools.html" target="_blank" rel="noopener noreferrer">Read the official restriction <ExternalLink size={15} /></a></SafetyCallout></div></section>
    <section className="container section"><DataDecisionTree /></section>
    <section className="method-sections section"><div className="container two-column-content"><article><p className="eyebrow">Inclusion standard</p><h2>What qualifies for this catalog</h2><ul className="check-list"><li>Current VT evidence says students can access the exact service.</li><li>The institutional account, eligibility, cost, and restrictions are stated separately.</li><li>Every capability and task fit resolves to a specific VT or ARC source ID.</li><li>Employee-only, limited-pilot, personal, paid, and external-benefit products are not student recommendations.</li></ul></article><article><p className="eyebrow">Recommendation method</p><h2>Hard filters cannot be outscored</h2><ol className="number-list compact-list"><li><span>01</span>Verify VT student access.</li><li><span>02</span>For Open OnDemand, require an ARC account, active allocation, and VT network or VPN.</li><li><span>03</span>Apply data-use restrictions, including the complete CUI/export-control stop.</li><li><span>04</span>Require every selected feature independently, then compare documented task fit.</li><li><span>05</span>Show one top fit or all equally suitable top matches alphabetically.</li></ol></article></div></section>
